...
export default function Profile() {
  ...
  const inputClass = "w-full bg-[#131A2A] border border-[#1F2937] rounded-xl py-3 px-4 text-white font-medium placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-black focus:border-black transition-all text-sm";
  ...
  return (
    <AppLayout title="Profile Settings">
      <motion.div 
        ...
        className="max-w-2xl bg-[#131A2A] border border-slate-100 p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)]"
      >
        {/* Header summary */}
        <div className="flex flex-col sm:flex-row items-center gap-6 mb-8 pb-8 border-b border-slate-100">
          {/* Avatar with Upload */}
          <div className="relative group">
            <div className="w-24 h-24 rounded-full overflow-hidden border-2 border-[#1F2937] bg-[#1F2937] flex items-center justify-center text-white text-3xl font-bold shadow-sm">
            ...
            <button
              ...
              className="absolute inset-0 bg-amber-400/60 rounded-full flex flex-col items-center justify-center text-white opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer text-xs font-bold"
            >
              {uploadingPhoto ? (
          ...
          <div className="text-center sm:text-left">
            ...
            <p className="text-xs font-medium text-slate-400 mt-1 flex items-center justify-center sm:justify-start gap-1.5">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <motion.button 
            ...
            type="submit"
            disabled={saving}
            className="w-full py-3.5 rounded-full text-sm font-bold text-slate-950 bg-amber-400 hover:bg-amber-500 hover:text-slate-950 shadow-md transition-all cursor-pointer disabled:opacity-60 flex items-center justify-center gap-2"
          >
            {saving ? (
              <>
