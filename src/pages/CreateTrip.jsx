  ...
  return (
    <AppLayout title="Plan a New Trip">
      <div className="max-w-2xl">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-black tracking-tight text-white">Plan a New Trip ✈️</h1>
          <p className="text-slate-400 mt-1 font-medium">Fill in the details below to start building your itinerary.</p>
        </div>

        {/* Pre-filled Destination Alert */}
        {paramDestination && (
          <div className="mb-6 p-4 rounded-2xl bg-gradient-to-r from-rose-500/10 via-amber-500/10 to-violet-500/10 border border-rose-200 text-white flex items-center justify-between gap-3 shadow-sm">
        ...
        <div className="bg-[#131A2A] rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-6">
            ...
            {/* Trip Name */}
            <div>
              <label className="block text-sm font-bold text-slate-300 mb-1.5">Trip Name *</label>
              <input
                type="text"
                name="name"
                required
                ...
                className="w-full border-2 border-[#1F2937] bg-[#131A2A] rounded-xl py-2.5 px-4 text-sm font-medium focus:outline-none focus:ring-1 focus:ring-black focus:border-black focus:bg-[#131A2A] transition-all"
              />
            </div>
            ...
            <div>
              ...
              {selectedPlace && (
                <div className="mt-2 flex items-center gap-2 bg-yellow-50 border border-yellow-200 text-white px-3 py-2 rounded-lg text-xs font-bold">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full border-2 bg-[#131A2A] rounded-xl py-2.5 px-4 text-sm font-medium focus:outline-none focus:ring-4 focus:ring-violet-500/10 focus:border-violet-500 focus:bg-[#131A2A] transition-all ${dateError ? "border-red-400" : "border-[#1F2937]"}`}
                />
              </div>
              <div>
                <label className="block text-sm font-bold text-slate-300 mb-1.5">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full border-2 border-[#1F2937] bg-[#131A2A] rounded-xl py-2.5 px-4 text-sm font-medium focus:outline-none focus:ring-1 focus:ring-black focus:border-black focus:bg-[#131A2A] transition-all resize-none"
              />
            </div>
            ...
            <div>
              ...
              {formData.coverPhotoUrl && (
                <img
                  ...
                  className="mt-2 h-36 w-full object-cover rounded-xl border border-[#1F2937] shadow-sm"
                />
              )}
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="50000"
                  className="w-full pl-8 pr-4 border-2 border-[#1F2937] bg-[#131A2A] rounded-xl py-2.5 text-sm font-medium focus:outline-none focus:ring-4 focus:ring-violet-500/10 focus:border-violet-500 focus:bg-[#131A2A] transition-all"
                />
              </div>
            </div>
            ...
            <div className="flex justify-end gap-3 pt-4 border-t border-slate-100">
              <button
                ...
                className="py-3 px-6 rounded-full text-sm font-bold text-slate-300 bg-[#1F2937] hover:bg-slate-200 focus:outline-none transition-all cursor-pointer"
              >
                Cancel
              </button>
              <button
                ...
                className="inline-flex items-center gap-2 py-3 px-8 rounded-full text-sm font-bold text-slate-950 bg-amber-400 hover:bg-amber-500 hover:text-slate-950 shadow-md focus:outline-none active:scale-95 transition-all disabled:opacity-60 disabled:cursor-not-allowed cursor-pointer"
              >
                {loading ? (
                  <>
